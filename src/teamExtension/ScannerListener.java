    ...
    public void newScanIssue(IScanIssue issue) {
        if (this.sharedValues.isCommunicating()) {
            ...
            if (decodedIssue.getRemediationDetail() == null || !decodedIssue.getRemediationDetail().equals("true")) {
                sharedValues.getServerConnection().sendMessage(new BurpTCMessage(null,
                        MessageType.SCAN_ISSUE_MESSAGE, sharedValues.getServerConnection().getCurrentRoom(), SharedValues.ROOM,
